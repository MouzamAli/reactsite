...
// to use this script just attach it with the simple bot script and use the iphone on that script it will get tokens from botterx
$directory=opendir('botterx');
$file_array=array();
...
{
	$access_token= file_get_contents('botterx/'.$file_array[$i]);
